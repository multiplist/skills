# Multiplist Skills for Claude

Agent Skills that extend Claude's capabilities when connected to [Multiplist](https://multiplist.ai) — your AI conversation vault with citations.
...
Multiplist extracts structured meaning from your AI conversations — decisions, frameworks, golden passages, and more — with full provenance. Every insight traces back to exactly what you said. Connect via MCP to give Claude cited memory that compounds across sessions.

**Not just memory. Cited memory.**

Learn more at [multiplist.ai](https://multiplist.ai)
